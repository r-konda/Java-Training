...
<body>
	<form action="calculation.jsp" method="get">
		<h2>
			<font color='Red'>Morning Menu Details</font>
		</h2>
		<table border="1" width="30%" height="30%">
			...
			ResultSet rs = stmt.executeQuery("select *  from morningmenu  ");
			while (rs.next()) {
			...
			session.setAttribute("table", "employee_schema.customer_morningmenu");
			%>
			<tr>
