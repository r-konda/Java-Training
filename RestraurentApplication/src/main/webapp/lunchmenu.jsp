...
<body>
	<h2>
		<font color='Red'>Lunch Menu Details</font>
	</h2>
	<form action="calculation.jsp" method="get">
		<table border="1" width="30%" height="30%">
			...
			ResultSet rs = stmt.executeQuery("select *  from lunchmenu  ");
			while (rs.next()) {
			...
			session.setAttribute("table", "employee_schema.customer_lunchmenu");
			%>
			<tr>
